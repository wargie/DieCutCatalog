...
Двойной щелчок по значению открывает карточку-статью. Через контекстное меню правой кнопки мыши значение можно просмотреть, отредактировать, удалить, продублировать в текущем списке, скопировать или перенести в другой справочник. Редактор статьи поддерживает заголовки, начертание, списки, выравнивание, ссылки и отмену действий. Удаление пользовательской группы выполняется только администратором через **Danger Zone** с повторным вводом пароля.
