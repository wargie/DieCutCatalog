...
Текущая стабильная версия ПК и сервера: **1.0.2**. Текущая предварительная версия Android: **0.2.0**.
...
Оператор вводит одно значение: тираж этикеток в штуках или пробег в метрах. Второе значение и целые обороты рассчитываются сервером и накапливаются автоматически.
