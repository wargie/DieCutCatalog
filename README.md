...
Текущая стабильная версия ПК и сервера: **1.9.0**. Текущая версия Android: **0.3.1**.
...
[Скачать DieCut Catalog 1.9.0 для Windows](https://github.com/wargie/DieCutCatalog/releases/download/v1.9.0/DieCutCatalog-1.9.0-win-x64.zip) · [Описание релиза](https://github.com/wargie/DieCutCatalog/releases/tag/v1.9.0)
...
```powershell
./scripts/Build-ClientRelease.ps1 -Version 1.9.0
```
