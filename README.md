...
Текущая стабильная версия ПК и сервера: **1.6.2**. Следующая версия Android: **0.3.0**.
...
- управляемое обновление Windows-клиента: отдельные подтверждения загрузки и установки, видимый прогресс, проверка SHA-256, откат при ошибке и автоматический перезапуск.
...
Порядок сборки и публикации описан в [docs/client-updates.md](docs/client-updates.md).
