...
- две роли — оператор и администратор — с серверной проверкой прав и подтверждением опасных операций паролем администратора;
...
В системе две роли. **Оператор** просматривает каталог, вводит тиражи, создаёт и редактирует карточки и работает с PDF. **Администратор** имеет те же возможности и дополнительно управляет справочниками, импортом и сотрудниками; удаление, списание и замена ножа подтверждаются паролем администратора в **Danger Zone**.
